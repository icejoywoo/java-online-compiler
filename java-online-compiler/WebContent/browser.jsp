...
<%!
	...
	*/
	...
	//private static final String RESTRICT_PATH = "/etc;/var"; // linux
	 ...
	 */
	private static final String CSS_NAME = "jsp-file-browser.css";
	/**
...
// 	private static final String UPLOAD_FILES = "Upload";
	...
	// 汉化按钮
	private static final String SAVE_AS_ZIP = "压缩下载(zip)";
	private static final String RENAME_FILE = "重命名文件";
	private static final String DELETE_FILES = "删除选中文件";
	private static final String CREATE_DIR = "创建文件夹";
	private static final String CREATE_FILE = "创建文件";
	private static final String MOVE_FILES = "移动文件";
	private static final String COPY_FILES = "复制文件";
	private static final String LAUNCH_COMMAND = "加载外部程序";
...
<%
			...
			for (int i = 0; i < entry.length; i++) {
				...
				for (int i2 = 0; i2 < FORBIDDEN_DRIVES.length; i2++) {
					if (entry[i].getAbsolutePath().toLowerCase().equals(FORBIDDEN_DRIVES[i2].toLowerCase())) forbidden = true;
				}
				if (!forbidden) {
